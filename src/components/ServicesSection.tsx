    ...
    <section id="services" className="py-24 bg-stone-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-serif text-4xl tracking-tight text-stone-900">Featured Salon Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-stone-100/60 flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-full bg-stone-50 flex items-center justify-center text-stone-900 mb-6 group-hover:bg-rose-50 group-hover:text-rose-500 transition-colors">
                <Scissors className="w-6 h-6" strokeWidth={1.5} />
              </div>
              <div className="flex items-baseline justify-between mb-2">
                <h3 className="font-serif text-xl text-stone-900">Director Precision Cuts</h3>
                <span className="text-xs font-semibold text-rose-500">Men $50+ / Women $65+</span>
              </div>
            ...
            <button
              ...
              className="text-xs font-semibold uppercase tracking-wide text-stone-900 group-hover:text-rose-500 transition-colors inline-flex items-center space-x-1 self-start cursor-pointer"
            >
          ...
          <div className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-stone-100/60 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-baseline justify-between mb-2">
                <h3 className="font-serif text-xl text-stone-900">Hair Dyeing & Balayage</h3>
                <span className="text-xs font-semibold text-rose-500">From $140+</span>
              </div>
              <p className="text-sm text-stone-500 leading-relaxed mb-6">
          ...
          <div className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-stone-100/60 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-baseline justify-between mb-2">
                <h3 className="font-serif text-xl text-stone-900">Digital & Texture Perms</h3>
                <span className="text-xs font-semibold text-rose-500">From $150+</span>
              </div>
              <p className="text-sm text-stone-500 leading-relaxed mb-6">
          ...
          <div className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-stone-100/60 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-baseline justify-between mb-2">
                <h3 className="font-serif text-xl text-stone-900">Japanese Straightening</h3>
                <span className="text-xs font-semibold text-rose-500">$280+ (Women)</span>
              </div>
              <p className="text-sm text-stone-500 leading-relaxed mb-6">
          ...
          <div className="group bg-white rounded-xl p-8 shadow-sm hover:shadow-md transition-all duration-300 border border-stone-100/60 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-baseline justify-between mb-2">
                <h3 className="font-serif text-xl text-stone-900">Kérastase & Caviar Rituals</h3>
                <span className="text-xs font-semibold text-rose-500">$80 – $180</span>
              </div>
              <p className="text-sm text-stone-500 leading-relaxed mb-6">
          ...
          <div className="group bg-stone-900 text-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-stone-800 flex flex-col justify-center items-center text-center">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-white text-stone-900 hover:bg-rose-400 hover:text-stone-900 text-xs font-semibold uppercase tracking-wider transition-all cursor-pointer shadow-md group-hover:scale-105"
            >
