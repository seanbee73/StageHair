...
export const StaffSection: React.FC<StaffSectionProps> = ({ onBookWithStylist }) => {
  return (
    <section id="team" className="py-24 bg-stone-50 border-t border-stone-200/40">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-serif text-4xl tracking-tight text-stone-900">Directors & Senior Stylists</h2>
            ...
            >
              <div>
                ...
                <div className="aspect-[4/5] overflow-hidden bg-stone-100 relative">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-stone-900/80 backdrop-blur-md text-white text-[10px] font-semibold tracking-wide uppercase px-2.5 py-1 rounded-full flex items-center gap-1">
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-1">
                    <div>
                      <h3 className="font-serif text-xl text-stone-900 font-semibold">{member.name}</h3>
                      {member.chineseRole && (
                  ...
                  <p className="text-xs font-medium text-rose-500 uppercase tracking-wide mb-3">
                    {member.role}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-2">
                    {member.specialties.map((spec, index) => (
                      <span
                        key={index}
                        className="text-[11px] font-medium bg-stone-100 text-stone-700 px-2 py-0.5 rounded-full"
                      >
                        {spec}
                      </span>
                    ))}
              ...
              <div className="px-6 pb-6 pt-2">
                <button
                  ...
                  className="w-full py-2.5 text-xs font-semibold uppercase tracking-wide rounded-full bg-stone-900 text-white hover:bg-rose-400 hover:text-stone-900 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer shadow-sm"
                >
